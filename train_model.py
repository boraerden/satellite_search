...
parser.add_argument('--save_to_model_path', default='kiln_model.ckpt', type=str)
parser.add_argument('--batch_size', default=32, type=int)
parser.add_argument('--num_workers', default=4, type=int)
parser.add_argument('--num_epochs1', default=5, type=int)
parser.add_argument('--num_epochs2', default=10, type=int)
parser.add_argument('--learning_rate1', default=5e-4, type=float)
...
def main(args):
    ...
    with graph.as_default():
        ...
        init_fn = tf.contrib.framework.assign_from_checkpoint_fn(pretrained_model_path, variables_to_restore)
    ...
    with tf.Session(graph=graph) as sess:
        ...
        for epoch in range(args.num_epochs1):
            ...
            if batch_mean_train_acc >= max_train_acc and batch_mean_valid_acc >= max_valid_acc:
                ...
                save_path = saver.save(sess, args.save_to_model_path)
