...
parser.add_argument('--val_dir', default='../data/kiln_val')
parser.add_argument('--logdir', default='tf_logs')
parser.add_argument('--model_path', default='tmp/model.ckpt', type=str)
...
def main(args):
    ...
    with tf.Session(graph=graph) as sess:
            ...
            logits, labels, summary = sess.run([logits, labels, summary_op], {is_training: False})
            ...
            val_writer.add_summary(summary, 1)
